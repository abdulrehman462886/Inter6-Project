...
import { Vegtableslist } from "../Alllarraysdata/homemadearrays";
import { useFocusEffect } from '@react-navigation/native';
const GotoHomemade = (props) => {
    ...
    return (
        <View key={rerenderKey} style={Styles.bodycontainer}>
            ...
            <Text style={Styles.TxtStyle}>Home Made</Text>
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    return (
                        <TouchableHighlight onPress={() => props.navigation.navigate("Homemadedetailsscreen", { items: item })} underlayColor={false}>
