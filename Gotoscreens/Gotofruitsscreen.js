...
import { Vegtableslist } from "../Alllarraysdata/fruitsarrays";
import { useFocusEffect } from '@react-navigation/native';
const GotoFruits = (props) => {
    ...
    return (
        <View key={rerenderKey} style={Styles.bodycontainer}>
            ...
            <Text style={Styles.TxtStyle}>Fruits</Text>
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    return (
                        <TouchableHighlight onPress={() => props.navigation.navigate("Fruitsdetailscreen", { items: item })} underlayColor={false}>
