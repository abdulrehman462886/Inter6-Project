...
import { Vegtableslist } from "../Alllarraysdata/sweetarrays";
import { useFocusEffect } from '@react-navigation/native';
const GotoSweets = (props) => {
    ...
    return (
        <View key={rerenderKey} style={Styles.bodycontainer}>
            ...
            <Text style={Styles.TxtStyle}>Sweets</Text>
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    return (
                        <TouchableHighlight onPress={() => props.navigation.navigate("Sweetdetailsscreen", { items: item })} underlayColor={false}>
