...
const Homemadedetailsscreen = ({ props, route }) => {
  const { items } = route.params;
  console.log({ items });
  const sliderimages = [
    require("../assets/homemade1.jpg"),
    require("../assets/homemade3.jpg"),
    require("../assets/homemade2.jpg"),
  ];
...
export default Homemadedetailsscreen;
