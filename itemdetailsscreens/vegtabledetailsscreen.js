...
import Carousel from '../components/caroselslidercomponent';
...
const Vegtabledetailsscreen = ({ route }) => {
  const { items } = route.params;

  const sliderimages = [
    require('../assets/sliderveg.jpg'),
    require('../assets/sliderveg1.jpg'),
    require('../assets/purplevegslider.jpg'),
  ];
...
export default Vegtabledetailsscreen;
